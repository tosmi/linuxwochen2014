...
\begin{frame}
  ...
  \begin{figure}[ht]
    \centering
      \includegraphics[height=6.2cm,width=11cm]{../pics/jenkins_pipeline.png}
    \label{fig:stack}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}[ht]
    \centering
%      \includegraphics[height=3cm,width=11.3cm]{../pics/jenkins_pipeline_detail.png}
      \includegraphics[height=1.3cm,width=11.3cm]{../pics/jenkins_pipeline_detail.png}
    \label{fig:stack}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}[ht]
    \centering
      \includegraphics[height=7.5cm,width=10cm]{../pics/jenkins_monitor.png}
    \label{fig:stack}
  \end{figure}
\end{frame}
